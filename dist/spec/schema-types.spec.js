...
const schema_types_1 = require("../middleware/schema-types");
...
describe('Schema-types test:', () => {
    ...
    */
    ...
    it(`should convert query sanitization`, () => {
        const result = schema_middleware_1.sanitize(island.sanitize.sanitize({
    ...
    it(`test validation for string array types `, () => {
        const GAME_MODE_ARRAY1 = ['ITEMINDIVIDUAL', 'ITEMTEAM', 'SPEEDINDIVIDUAL', 'SPEEDTEAM'];
        const GAME_MODE_ARRAY2 = ['ITEMINDIVIDUAL', 'ITEMTEAM', 'SPEEDINDIVIDUAL', 'SPEEDTEAM'];
